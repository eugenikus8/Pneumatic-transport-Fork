...
pneumaticFluids = {}
pneumaticRecipes = {}
for _, tbl in ipairs({ data.raw.item, data.raw.module, data.raw.ammo, data.raw.armor, data.raw.capsule, data.raw.tool, data.raw["repair-tool"], data.raw["item-with-entity-data"], data.raw["rail-planner"] }) do for name, item in pairs(tbl) do
