...
local function on_dolly_moved(event)
  ...
  -- move inserters
  local pinserters = entity.surface.find_entities_filtered { type = "inserter", name = {"pneumatic-hidden-intake", "pneumatic-hidden-outtake"}, position = old_pos, area = {{-0.5, -0.5}, {0.5, 0.5}}}
